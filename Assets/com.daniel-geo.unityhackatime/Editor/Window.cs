...
namespace WakaTime
{
    public class Window : EditorWindow
    {
        ...
        private static bool _ignoreRateLimitErrors = false;
        ...
        void OnGUI()
        {
            ...
            _ignoreRateLimitErrors = EditorGUILayout.Toggle("Ignore Rate Limit Errors", _ignoreRateLimitErrors);
            ...
            if (GUILayout.Button("Save Preferences"))
            {
                ...
                EditorPrefs.SetBool(Plugin.RATELIMITERROR_PREF, _ignoreRateLimitErrors);
                Plugin.Initialize();
            }
        ...
        void OnFocus()
        {
            ...
            if (EditorPrefs.HasKey(Plugin.RATELIMITERROR_PREF))
                _ignoreRateLimitErrors = EditorPrefs.GetBool(Plugin.RATELIMITERROR_PREF);

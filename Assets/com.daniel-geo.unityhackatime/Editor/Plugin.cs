...
namespace WakaTime
{
    ...
    public class Plugin
    {
        ...
        public const string RATELIMITERROR_PREF = "WakaTime/IgnoreRateLimitErrors";
        ...
        public static void Initialize()
        {
            ...
            if (EditorPrefs.HasKey(RATELIMITERROR_PREF))
                _ignoreRateLimitErrors = EditorPrefs.GetBool(RATELIMITERROR_PREF);
              ...
              JsonUtility.FromJson<Response<HeartbeatResponse>>(
                request.downloadHandler.text);
                  ...
                  if (response.error != null)
                  {
                      ...
                      else if (_ignoreRateLimitErrors && response.error == "Rate limit exceeded")
                      {
                          // Don't do anything
                      }
                      else
